...
MB.CARDS = {
  ...
  'suzu':                 { cost: 2, atk: 2, hp: 2, rarity: 'common', kw: [],
    ...
    attack: { style: 'barrage', name: 'Star Sign Shower', color: '#c9a8ff', emoji: '⭐' },
  ...
  'evil-villainess-chan': { cost: 5, atk: 4, hp: 4, rarity: 'epic', kw: [], name: 'Evil Villainess-chan',
    ...
    attack: { style: 'shout', name: 'Villainous Laugh', shout: 'OHOHOHO!', color: '#8b3dff' },
  ...
  'linda-garmund':   { cost: 3, atk: 2, hp: 4, rarity: 'rare', kw: [],
    ...
    attack: { style: 'orb', name: 'Harp Serenade', color: '#b5651d', emoji: '🎵' },
...
MB.BONDS = [
  ...
  { id: 'nanashi-family', pair: ['keiko', 'ai'], costumes: [null, null], tier: 1,
    ...
    attack: { style: 'combo', name: 'Sealed Eye Duet', color: '#c22d4f', emoji: '🌙' } },
  { id: 'sensei-fan', pair: ['ai', 'misaki'], costumes: [null, null], tier: 1,
    ...
    attack: { style: 'combo', name: 'Love Letter Barrage', color: '#e0245e', emoji: '💌' } },
  ...
  { id: 'hostage-standoff', pair: ['shino-okita', 'bandit'], costumes: [null, null], tier: 1,
    ...
    attack: { style: 'combo', name: 'Steel & Smoke', color: '#8b5a2b', emoji: '⚔️' } },
  // Fake It to Make It!
  ...
  { id: 'roberts-family', pair: ['juliana', 'joseph'], costumes: [null, null], tier: 1,
    ...
    attack: { style: 'combo', name: 'Kangaroo Kick-Off', color: '#e39b6b', emoji: '🦘' } },
  { id: 'cheer-rivals', pair: ['saria', 'jane'], costumes: [null, null], tier: 1,
    ...
    attack: { style: 'combo', name: 'Pom-Pom Clash', color: '#e8b030', emoji: '📣' } },
...
MB.BOND_SCENES = {
  ...
  // Atarashī gakkō; Secret Garden!
  'shirayuki-dynasty': { kind: 'family', scene: 'meal', lines: ['Mother, the council approved it~', '...Good.'], food: ['🍵', '🍰', '🫖'] },
  ...
  'sensei-fan':        { kind: 'school', scene: 'class', lines: ['Sensei, I wrote you a poem!', '...Is it on the syllabus?'], board: 'Ichinose-sensei ♥' },
  ...
  'shinsengumi':       { kind: 'friends', lines: ['Shino! On your left!', '...Already there.'] },
  ...
  // Fake It to Make It!
  'the-squad':         { kind: 'friends', lines: ['Friendship bracelet, bro!', 'Yay! Squad forever!'] },
  ...
  'tryouts':           { kind: 'school', scene: 'class', lines: ["I-I know the routine!", "...You're in. Don't make me regret it."], board: 'CHEER TRYOUTS' },
  ...
  'date-night':        { kind: 'lovers', lines: ['Easy there, cowboy.', "Duuude... you're the best."] },
  ...
  'lab-partners':      { kind: 'school', scene: 'class', lines: ['...Your data is adequate.', 'Aww, was that a compliment?'], board: 'Data ≠ Feelings' },
};
