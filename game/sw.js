...
const SHELL_FILES = [
  ...
  'js/data.js', 'js/content.js', 'js/collection.js', 'js/missions.js', 'js/effects.js', 'js/audio.js', 'js/engine.js', 'js/ai.js', 'js/fx.js', 'js/view.js', 'js/ui.js', 'js/cards.js', 'js/menutips.js', 'js/main.js',
